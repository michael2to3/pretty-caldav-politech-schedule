...
class FormatUrl {
  ...
  private final static DateTimeFormatter FORMAT_DATE =
      DateTimeFormatter.ofPattern(PATTERN_FORMAT_DATE)
  ...
  public static String getSchedule(final String domain, final String numGroup, final Instant date) {
    ...
    return domain
        + GET_SCHEDULE.replace(PATTERN_NUMBER, numGroup).replace(PATTERN_DATE_FORMAT, fdate);
  }
}
